...
export default function CommerceReviewNewForm({ onClose, ...other }) {
      ...
      <FormProvider methods={methods} onSubmit={onSubmit}>
        ...
        <DialogContent>
          <Stack direction="row" flexWrap="wrap" alignItems="center" spacing={1.5}>
            <Typography variant="body2">Your review about this commerce:</Typography>
...
CommerceReviewNewForm.propTypes = {
