...
export async function getCommerceById(id) {
  try {
    const URL = `https://6pg61wv2-3000.brs.devtunnels.ms/commerce/${id}`;
...
export async function createCommerce(commerce) {
  const URL = `https://6pg61wv2-3000.brs.devtunnels.ms/commerce`;
...
export async function changeCommerceStatus(id, status) {
  console.log(status);
  const URL = `https://6pg61wv2-3000.brs.devtunnels.ms/commerce/status/${id}`;
...
export async function activateCommerce(id) {
  const URL = `https://6pg61wv2-3000.brs.devtunnels.ms/commerce/activate/${id}`;
...
export function useGetCommerce(commerceId) {
  const URL = `https://6pg61wv2-3000.brs.devtunnels.ms/prodcommerceuct/${commerceId}`;
