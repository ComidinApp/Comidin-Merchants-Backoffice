...
export const _roles = ['Supervisor', 'Administrador', 'Delivery'];
...
export const _descriptions = [
  `Registrá tu comercio con tus datos. Luego de que evaluemos tu comercio, te contactaremos para coordinar el inicio de tu cuenta. Si tu solicitud es aprobada, puedes iniciar sesión y comenzar a ahorrar.`,
  `No cobramos ninguna comisión en los pedidos realizados..`,
  `Comidin está destinado a comercios de alimentos y bebidas que quieran reducir su desperdicio de alimentos.`,
  `En caso de que desees devolver un pedido, podras hacerlo desde la aplicación. Notificaremos al comercio de tu solicitud y compartiremos medios de contactos para que puedas coordinar el retorno del pedido.`,
  `Podes pagar con Mercado Pago directamente desde la aplicación o en efectivo en el comercio.`,
  `Para registrarte, podes hacerlo a través del formulario en nuestra web en caso de quieras vender o a través de la aplicación para comenzar a ahorrar en tus compras.`,
];
