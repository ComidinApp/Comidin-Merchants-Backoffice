...
export const _pricingPlans = [
  {
    ...
    price: 0,
    caption: 'Forever',
    lists: ['Hasta 15 publicaciones disponibles', '3 Boards', 'Atención al cliente'],
  ...
  },
  {
    ...
    lists: [
      'Máxima visibilidad en la app',
      'Acceso a todas las herramientas de análisis y estadísticas',
      'Atención al cliente personalizada y dedicada',
